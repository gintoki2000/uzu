...
static BTTask_SetDestToSpot* set_dest_to_spot_init(BTTask_SetDestToSpot* self);
static BTStatus      set_dest_to_spot_exec(BTTask_SetDestToSpot* self, Ecs* ecs, ecs_entity_t entity);

BT_VTBL_INST_FN(BTNode, set_dest_to_spot)
BT_ALLOC_FN(BTTask_SetDestToSpot, set_dest_to_spot)
