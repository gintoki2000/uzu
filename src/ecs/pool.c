...
static void ecs_pool_swp_internal(EcsPool* self, ecs_size_t cidx1, ecs_size_t cidx2)
{
...
{
  ecs_pool_swp_internal(self,
                        self->sparse.data[ECS_ENT_IDX(e1)],
                        self->sparse.data[ECS_ENT_IDX(e2)]);
}

ecs_size_t ecs_pool_cnt(EcsPool* self) { return self->dense.cnt; }
