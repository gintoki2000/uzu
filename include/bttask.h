...
typedef struct BTTask_Follow                           BTTask_Follow;
typedef struct BTTask_SetFollowingTargetToAttackTarget BTTask_SetFollowingTargetToAttackTarget;
typedef struct BTTask_SetAttackTargetToAttacker        BTTask_SetAttackTargetToAttacker;
...
BTTask_Follow*                    bt_task_follow(float distance);
#endif // BT_TASK_H
